            ...
            <div className='container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16'>
                <div className='flex justify-between items-center h-16 sm:h-18 lg:h-20 xl:h-22 2xl:h-24'>
                    ...
                    <div className='hidden lg:flex lg:items-center'>
                        <button className='bg-gradient-to-br from-yellow-400 to-orange-600 hover:from-yellow-500 hover:to-orange-700 text-white font-bold px-4 py-2 lg:px-6 lg:py-3 xl:px-8 xl:py-4 2xl:px-10 2xl:py-5 rounded-lg text-sm lg:text-base xl:text-lg 2xl:text-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1'>
                            টিকেট কিনুন
                        </button>
                    </div>
