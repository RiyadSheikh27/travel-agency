...
const Neog = () => {
  ...
  // Show only 6 cards
  const displayedCards = category.slice(0, 6);
  ...
  return (
    <div className="flex justify-center items-center bg-gradient-to-r from-yellow-50 to-orange-200 pt-20 pb-20 ">
      <div>
        {/* Title + button */}
        <div className="pb-10 text-center space-y-4">
          <div className="justify-between items-center px-4 lg:px-0">
            <h1 className="lg:text-5xl text-xl text-black font-bold">
              নিয়োগ সমূহ
            </h1>
          </div>
          ...
          {/* Button under subtitle */}
          <div className="mt-4">
            <Link
              to="/allNeogs"
              className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-4 py-2 rounded-md shadow"
            >
              সকল নিয়োগ
            </Link>
          </div>
